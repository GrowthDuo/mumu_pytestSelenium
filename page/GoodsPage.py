...
class GoodsPage(GoodsBase, ObjectMap):
    ...
    def input_goods_details(self, driver, input_value):
        ...
        :return:
        '''
        details_xpath = self.goods_details()
        return self.element_fill_value(driver, By.XPATH, details_xpath, input_value)
    ...
    def upload_goods_img(self, driver, img_name):
        ...
        #
        upload_img_xpath = self.goods_img()
        # 上传
        return self.upload(driver,By.XPATH, upload_img_xpath, img_path)
